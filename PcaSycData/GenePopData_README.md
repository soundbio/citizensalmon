genepop_data.py, population.py and main.py script files are used in conjunction with GenePop formated data such as 'genepop_western_alaska_chinook_RAD.txt'.
