...
class GenePopData(PopApi):
    """class to read and massage GenePop data for PCA"""

    # initialization
    def __init__(self, genepopFilepath):
        PopApi.__init__(self, None)
        with open(genepopFilepath, 'r', 1) as fp:
            self.__read(fp)
